param([parameter(Mandatory=$false)]   [string] $resourceGroup = "aks-engine-workshop-rg",
      ...
      [Parameter(Mandatory=$false)] [string] $ingHostName = "internal.wkshpdev.com",
      [Parameter(Mandatory=$false)] [string] $listenerHostName = "wkshpdev.com",
      [Parameter(Mandatory=$false)] [string] $baseFolderPath = "/Users/monojitd/Materials/Projects/AKSProjects/AKSEngineWorkshop/Deployments")
